...
export let internetUsers = [
  ...
  },
  {
    rank: 3,
    name: 'United States',
    value: bubblesize(245436423),
    color: '#99295D ',
    population: 245436423,
  },
  {
    rank: 4,
    name: 'Brazil',
    value: bubblesize(123927230),
    color: '#364A98',
    population: 123927230,
  },
  {
    rank: 5,
    name: 'Japan',
    value: bubblesize(117528631),
    color: '#7F38A0 ',
    population: 117528631,
  },
  {
    rank: 6,
    name: 'Russia',
    value: bubblesize(110003284),
    color: '#2E769F',
    population: 110003284,
  },
...
function bubblesize(value) {
  let max = 1347565324;
  let min = 324366;
  let maxBox = 70 * 70 * 2 * Math.PI;
  let minBox = 3 * 3 * 2 * Math.PI;
  let box = ((value - min) / (max - min)) * (maxBox - minBox) + minBox;
  if (box < minBox) {
    box = minBox;
  }
